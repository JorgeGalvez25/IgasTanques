...
uses
  ...
  Dialogs, ScktComp, StdCtrls, AdvToolBar, CRCs, OG_Hasp;
...
var
  i:Integer;
  json,jsonT,jsonP,mensaje:string;
begin
  try
...
//            'VentaMaximaLitros=999' + #13#10 +'VentaMaximaPesos=9999|';
      json:='|DISPENSERS|INITIALIZE|{"Consoles":[{"ConsoleId":1,"Connection":"SERIAL,COM3,2400,N,8,1","Protocol":"Hong Yang","LastDispenser":1}],"Products":[{"ProductId":2,"Name":"PREMIUM","Price":21},'+
            ...
            '"Blocked":false,"Hoses":[{"HoseId":1,"ProductId":1}]},{"DispenserId":2,"MaximumSale":9999,"Units":"MONEY","OperationMode":"FULLSERVICE","Blocked":false,"Hoses":[{"HoseId":2,"ProductId":1}]}]}';
      ...
      ClientSocket1.Socket.SendText(Key.Encrypt(#1+'a13f'+#2+mensaje+#3+CRC16(mensaje)+#23));
    end
    else begin
...
procedure TForm1.ClientSocket1Read(Sender: TObject;
  ...
  var
    ...
    lin,lin2:string;
begin
  lin:=Key.Decrypt(Socket.ReceiveText);
